...
#from users.serializers.user_serializers CustomUserSerializer
...
#         masters =  CustomUser.objects.filter(profession_category=category, is_active=True)
...
#         serializer = CustomUserSerialize(result_page, many=True)
