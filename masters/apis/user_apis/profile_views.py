...
class ProfileUpdateAPIView(APIView):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            ...
            openapi.Parameter('work_images', openapi.IN_FORM, type=openapi.TYPE_FILE, description="İş şəkillərinin faylları (max 10)", collectionFormat='multi', required=False),
