...
class ProfileUpdateAPIView(APIView):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            ...
            openapi.Parameter('new_password', openapi.IN_FORM, type=openapi.TYPE_STRING, format='password', description="Şifrə", required=False),
            openapi.Parameter('new_password_two', openapi.IN_FORM, type=openapi.TYPE_STRING, format='password', description="Şifrə təsdiqi", required=False),
