...
class ProfileUpdateAPIView(APIView):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            ...
            openapi.Parameter('password', openapi.IN_FORM, type=openapi.TYPE_STRING, format='password', description="Şifrə", required=False),
            openapi.Parameter('password_two', openapi.IN_FORM, type=openapi.TYPE_STRING, format='password', description="Şifrə təsdiqi", required=False),
