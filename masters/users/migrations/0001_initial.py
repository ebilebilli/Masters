    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message='Yalnız Azərbaycan əlifbasındakı hərflərə icazə verilir.', regex='^(?=.*[A-Za-zƏəÖöĞğÜüÇçŞşİı])[A-Za-zƏəÖöĞğÜüÇçŞşİı\\s]+$')], verbose_name='Ad')),
                ('last_name', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message='Yalnız Azərbaycan əlifbasındakı hərflərə icazə verilir.', regex='^(?=.*[A-Za-zƏəÖöĞğÜüÇçŞşİı])[A-Za-zƏəÖöĞğÜüÇçŞşİı\\s]+$')], verbose_name='Soyad')),
                ...
                ('custom_profession', models.CharField(blank=True, max_length=50, null=True, validators=[django.core.validators.RegexValidator(message='Yalnız Azərbaycan hərfləri və rəqəmləri ilə yazılmalıdır.', regex='^[a-zA-ZəƏöÖüÜşŞçÇğĞıİ0-9\\s.,!?-]+$')])),
                ...
                ('education_speciality', models.CharField(blank=True, max_length=50, validators=[django.core.validators.RegexValidator(message='Yalnız Azərbaycan hərfləri və rəqəmləri ilə yazılmalıdır.', regex='^[a-zA-ZəƏöÖüÜşŞçÇğĞıİ0-9\\s.,!?-]+$')], verbose_name='Təhsil üzrə ixtisas')),
                ...
                ('note', models.TextField(blank=True, max_length=1500, validators=[django.core.validators.RegexValidator(message='Yalnız Azərbaycan hərfləri və rəqəmləri ilə yazılmalıdır.', regex='^[a-zA-ZəƏöÖüÜşŞçÇğĞıİ0-9\\s.,!?-]+$')], verbose_name='Əlavə qeyd')),
                ...
                ('cities', models.ManyToManyField(blank=True, related_name='city_masters', to='core.city', verbose_name='Şəhərlər')),
                ('districts', models.ManyToManyField(blank=True, related_name='district_masters', to='core.district', verbose_name='Bakı bölgələri')),
